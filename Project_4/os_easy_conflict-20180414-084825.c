...
char helpMsg[] = "Command list:ls - Show list of process.1~4 - Select process you want to run. cln - Clean up the screen. info [programname]: more info for selected program";
